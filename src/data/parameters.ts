...
export const parameters: PromptParameter[] = [
  ...
  { id: "lighting-volumetric", category: "lighting", styleGroup: "dramatic", zhName: "体积光", enName: "Volumetric Light", defaultWeight: 1, image: img("lighting-volumetric"), zhPrompt: "体积光，云层中穿透的光束", enPrompt: "dramatic volumetric light rays cutting through atmosphere" },
